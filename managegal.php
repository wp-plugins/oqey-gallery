...
jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { delimgid: id },
            function(data){
			...
			jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { undoimgid: id },
            function(r){
...
function ajaxUploader(id){
		...
		new AjaxUpload(btnUpload, {
			action:  userSettings['url'] + 'wp-content/plugins/oqey-gallery/bcupload.php?&id=' + id,
			name: 'Filedata',
...
function getGalleryDetails(id){	
	        ...
	        jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { newgallid: id, wpnonce: '<?php echo wp_create_nonce('oqey-upload'); ?>' },
            function(data){
			var data = eval('(' + data + ')');
            jQuery('#content').hide().html(decodeURIComponent(data.response)).fadeIn("slow");
			jQuery('#titlul_b').show();
			jQuery('#titlul').hide().html("Gallery title: " + decodeURIComponent(data.titlul)).fadeIn("slow");
			...
			jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { usrid: usrid, gid: id },function(data){ } );
			});
			...
			jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { allimages: data.galid },
            function(data){
			var data = eval('(' + data + ')');
			...
			jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { orderallimgs: allimgs, galleryid: id },
            function(data){}
			);			
			} 			
			});
...
jQuery("#oqeymusic").click(function(){ 
  ...
  if (jQuery("#musicpostbox").is(":hidden")) {
	  ...
	  jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { music_gall_id: id },
            function(data){  			
			...
			var id = jQuery('#currentGalID').val();	
            jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { selectedmusic: selectedmusic, mgalleryid: id },
...
jQuery("#oqeyskin").click(function(){ 
  ...
  if (jQuery("#skinpostbox").is(":hidden")) {
	  ...
	  var id = jQuery('#currentGalID').val();	
	  jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { skin_gall_id: id },
            function(data){  			
			...
			jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { skinid: skinid, skin_gallery_id: id },
            function(data){ jQuery("#messages").hide().html('<p class="updated fade">' + data + '<\/p>').fadeIn("slow"); clearUp();
...
if(id==2){
		...
		jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { imgalltotrash: encodeURIComponent(names) },
        function(data){
		if(names.length>0){
		jQuery("#messages").hide().html(decodeURIComponent('<p class="updated fade">' + data + ' <a href="#undo" id="undoallimages">undo<\/a><\/p>')).fadeIn("slow"); 
			...
			jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { imgallfromtrash: encodeURIComponent(names) },
            function(r){
...
function deleteGallery(id){ 
            jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { movetotrashgall: id },
            function(data){
			...
			jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { undogallid: id },
            function(r){
			var data = eval('(' + r + ')');		
...
/*loading galleries*/	
jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { allgalls: "yes" },
   function(data){
...
jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { previewid: id, flash: flash  },
   function(r){       
		...
		return false;
	        ...
	        jQuery(".dblclick").editable( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { 
			name: "gal_edit_title",
			id: "gal_edit_id",
            indicator : 'Updating...',
...
jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { newtitle: newtitle },
 function(html){
         var data = eval('(' + html + ')');
...
jQuery( "#updatedetails" ).click(function() {            
   ...
   jQuery.ajax({
   type: "POST",
   url:  userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php",
   data: alldata,
...
jQuery.post( userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { imagedetails: id },
            function(data){
				var data = eval('(' + data + ')');
...
<?php echo get_option("oqey_license_text"); ?>
</div>
