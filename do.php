...
if($d){
 if(is_dir(str_replace('\\', '/', ABSPATH)."wp-content/plugins/oqey-gallery/skins/".mysql_real_escape_string($_POST['name'])) ){   
 $dir = str_replace('\\', '/', ABSPATH)."wp-content/plugins/oqey-gallery/skins/".mysql_real_escape_string($_POST['name']);
 $do = rm($dir);
if($do){ 
