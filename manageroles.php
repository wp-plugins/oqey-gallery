<?php
if (!empty($_SERVER['SCRIPT_FILENAME']) && 'manageroles.php' == basename($_SERVER['SCRIPT_FILENAME']))
...
if (isset($_POST['update_roles'])){	
	...
	echo '<div class="wrap"><div class="updated fade" id="message"><p>Roles updated.</p></div></div>';
}
