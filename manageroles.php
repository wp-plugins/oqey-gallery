	...
	oqey_set_roles($_POST['oQeyTrash'],"oQeyTrash");
        ...
        $mesaj = '<div class="wrap">
                   <div class="updated below-h2" id="message">
                     <p>'.__('Roles updated.', 'oqey-gallery').'</p>
                   </div>
                  </div>';
}
?>
   <div class="wrap">
       <h2 style="width:830px;"><?php _e('Roles', 'oqey-gallery'); ?></h2>
	...
	<form name="oqey_roles" id="oqey_roles" method="POST" accept-charset="utf-8" >
		<?php wp_nonce_field('oqey_add_roles') ?>
			...
			<tr valign="top"> 
                            <th scope="row"><?php _e('Manage Settings', 'oqey-gallery'); ?>:</th> 
...
<div class="qr" style="position: fixed; top: 50px; right: 50px;">
