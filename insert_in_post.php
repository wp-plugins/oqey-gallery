...
<?php 
   ...
   if($j%2){ $colorb = '#F4FAFF'; }else{ $colorb = '#E8F4FF'; }  
	...
	echo '<tr>	
			  ...
			  <a href="#null" onclick="inoQeyContent(\''.$i->id.'\', \''.$_GET['post_id'].'\')">
			  <img src="'.get_option('siteurl').'/wp-content/oqey_gallery/galleries/'.$i->folder.'/galthmb/'.$img->title.'" alt="image" class="addinpost" style="border:0;"/></a>
              </div>	           
...
function inoQeyContent($html_link, id){
var win = window.dialogArguments || opener || parent || top;
var html = "[oqeygallery:" + $html_link + " " + id + "]";
