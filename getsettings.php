...
echo 'MaximumWidth='.$maxw.'&MaximumHeight='.$maxh.'&GalleryWidth='.get_option('oqey_width').'&GalleryHeight='.get_option('oqey_height').'&CropOption='.$crop.'&ThumbWidth='.get_option('oqey_thumb_width').'&ThumbHeight='.get_option('oqey_thumb_height').'&TransitionTime='.get_option('oqey_effects_trans_time').'&TransitionInterval='.get_option('oqey_pause_between_tran');
?>