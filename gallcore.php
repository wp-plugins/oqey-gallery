...
class oQey_Gallery_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
        ...
        $gal = $wpdb->get_row("SELECT * FROM $oqey_galls WHERE id ='".$instance['oqeygalleryid']."'");
        $folder = $gal->folder;
        ...
        $all = $wpdb->get_results("SELECT * FROM $oqey_images WHERE gal_id = '".$instance['oqeygalleryid']."' AND status!=2 ".$s." ORDER BY img_order ASC");
   ...
   foreach($all as $i){ 
	...
	function form( $instance ) {
        ...
        $oqeywidgettext  =  esc_attr($instance['oqeywidgettext']);        
...
function oQeyGalleryPermDelete(){
   ...
   $e="";
   $d = $wpdb->query( $wpdb->prepare("DELETE FROM $oqey_galls WHERE id = '%d'", $_POST['deletegall']) );
   $r = $wpdb->query( $wpdb->prepare("DELETE FROM $oqey_music_rel WHERE gallery_id = '%d'", $_POST['deletegall']) );
   $d = $wpdb->query( $wpdb->prepare("DELETE FROM $oqey_images WHERE gal_id = '%d'", $_POST['deletegall']) );   
