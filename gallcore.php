...
<?php
			...
			}elseif(isset($_GET['settings-updated']) == "false"){
...
<table width="450" border="0" cellpadding="1" cellspacing="0">
  <tr valign="top">
<th width="252" height="25" align="left" valign="middle" scope="row"><div align="left">Gallery Width</div></th>
<td width="194" height="25" align="left" valign="middle"><input name="oqey_width" id="oqey_width" type="text" value="<?php echo get_option('oqey_width'); ?>" size="5"/> pix (min. 200)</td>
</tr>
<tr valign="top">
...
<th width="252" height="25" align="left" valign="middle" scope="row">Width:</th>
...
<tr valign="top" style="display:none;" class="maxon">
<th width="252" height="25" align="left" valign="middle" scope="row">Height:</th>
...
<table width="900" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="657" height="25"><input name="oqey_thumb_width" id="oqey_thumb_width" type="text" value="<?php echo get_option('oqey_thumb_width'); ?>" size="5"/> pix (min. 60, max. 180)</td>
    </tr>
    <tr>
    <td width="258" height="25"><strong>Thumbs height</strong></td>
    <td width="657" height="25"><input name="oqey_thumb_height" id="oqey_thumb_height" type="text" value="<?php echo get_option('oqey_thumb_height'); ?>" size="5"/> pix (min. 40, max. 120)</td>
  </tr>
      <tr>
    ...
    <td width="657" height="25"><input name="oqey_effects_trans_time" id="oqey_effects_trans_time" type="text" value="<?php echo get_option('oqey_effects_trans_time'); ?>" size="5"/> seconds (min. 0.1, max. 1.5)</td>
  </tr>
  <tr>
    <td width="258">Pause between transitions:</td>
    <td width="657"><input name="oqey_pause_between_tran" id="oqey_pause_between_tran" type="text" value="<?php echo get_option('oqey_pause_between_tran'); ?>" size="5"/> seconds</td>
</tr>
<tr valign="top">
...
<tr valign="top">
<td height="10" colspan="2" align="left" valign="middle" scope="row">&nbsp;</td>
</tr>
</table>
<table width="900" border="0" cellspacing="0" cellpadding="0">
<tr valign="top">
...
if ($isCrawler){
    ...
    $imgs = '[p align="center"]'.$gal_title.'[/p]';
	$imgs .= '[span class="all_images"]'; foreach($all as $i){ $imgs .= '[img src="'.get_option('siteurl').'/wp-content/plugins/oqey-gallery/oqeyimgresize.php?width='.$oqey_width.'&amp;folder='.$gal->folder.'&amp;img='.trim($i->title).'" alt="'.urlencode(trim($i->alt)).'"/]'; } $imgs .= '[/span]';
	if(get_option("oqey_backlinks")=="on"){ $imgs .= '[p align="center" style="font-size:11px;"]powered by &copy; [a href="http://oqeysites.com" target="_blank"]oQeySites[/a][/p]'; }	
