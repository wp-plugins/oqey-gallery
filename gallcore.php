           ...
           if(!empty($images)){
               ...
               if($i->splash_img!=0){
                ...
                $image = oQeyGetImageLink($img, $i);
                  ...
                  echo '<div onclick="InsertOqeyGalleryInContent(\''.$i->id.'\')" class="attachmentq attachment-preview">';
		  echo '<div class="thumbnail">';
                  echo '<img src="'.$image['thmb'].'" class="icon">';
...
function AddoQeyGallery($atts){
   ...
   if($gal){
    ...
    if( get_option('oqey_noflash_options')=="injsarrtouch" ){ 
        ...
        $optouch = " data-cycle-swipe=true";
        //$optouch .= ' data-cycle-fx="scrollHorz"';
