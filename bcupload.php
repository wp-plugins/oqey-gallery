...
if( isset($_REQUEST['loc']) || isset($_REQUEST['id'])){
$folder = getFolder($gal_id);
$filespath = OQEY_ABSPATH.'wp-content/oqey_gallery/galleries/'.$folder."/galimg/";
$filespaththumb= OQEY_ABSPATH.'wp-content/oqey_gallery/galleries/'.$folder."/galthmb/";
$iphonepath= OQEY_ABSPATH.'wp-content/oqey_gallery/galleries/'.$folder."/iphone/";
