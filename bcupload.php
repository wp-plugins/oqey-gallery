			...
			if(!isset($path['filename'])){ 
  			...
  			while(1){				
				...
				$file = $filespath.$name; 				
                    ...
                    /*
                    oqey_img_resize( $_FILES["Filedata"]["tmp_name"], $filespath, $name, "1200", "1800", "no" );
                    oqey_img_resize( $_FILES["Filedata"]["tmp_name"], $filespaththumb, $name, "100", "150", "no");	
 					oqey_img_resize( $file, $iphonepath, $name, "640", "960", "no");
                    */
