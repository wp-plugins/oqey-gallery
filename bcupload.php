...
$filespath = ABSPATH.'wp-content/oqey_gallery/galleries/'.$_GET['folder'].'/galimg/';
$filespaththumb = ABSPATH.'wp-content/oqey_gallery/galleries/'.$_GET['folder'].'/galthmb/';	
$iphonepath = ABSPATH.'wp-content/oqey_gallery/galleries/'.$_GET['folder'].'/iphone/';
$gal_id = $_GET['id'];
}
