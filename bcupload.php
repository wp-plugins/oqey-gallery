<?php
//if( isset($_GET['loc']) || isset($_GET['folder']) ){
include("../../../wp-load.php");
global $wpdb;
...
$filespath = OQEY_ABSPATH.'wp-content/oqey_gallery/galleries/'.$_GET['folder'].'/galimg/';
$filespaththumb = OQEY_ABSPATH.'wp-content/oqey_gallery/galleries/'.$_GET['folder'].'/galthmb/';	
$iphonepath = OQEY_ABSPATH.'wp-content/oqey_gallery/galleries/'.$_GET['folder'].'/iphone/';
$gal_id = $_GET['id'];
}
