...
$myFile = OQEY_ABSPATH."wp-content/oqey_gallery/skins/".oqey_getBlogFolder($wpdb->blogid).$skin."/details.php";
$fh = @fopen($myFile, 'r');
...
?>
    ...
    <td width="246" align="right" valign="middle"><div style="margin-right:20px; padding:5px;"><a href="http://oqeysites.com/category/wp-photo-gallery-skins/" target="_blank"><strong>Get more skins</strong></a></div></td>
  </tr>
</table>
