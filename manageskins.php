...
$root = str_replace('\\', '/', ABSPATH)."wp-content/oqey_gallery/skins/";
...
$myFile = str_replace('\\', '/', ABSPATH)."wp-content/oqey_gallery/skins/".$skin."/details.php";
$fh = fopen($myFile, 'r');
...
<div id="flashuploader" style="width:100px; height:30px;"><a href="http://www.macromedia.com/go/getflashplayer" target="_blank" class="style4">GET FLASH </a></div>	   
      <script type="text/javascript">
	var flashvars = {BatchUploadPath:"<?php echo str_replace('\\', '/', ABSPATH); ?>wp-content/oqey_gallery/skins/",
