...
function refreshPage(){
	window.location = "<?php echo get_option('siteurl'); ?>/wp-admin/admin.php?page=oQeySkins&scaner=true";
}
...
<table width="900" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td width="175" height="50" align="right" valign="middle">Upload a new skin (*.zip)</td>
    <td width="123" height="50" align="right" valign="middle">
...
?>
    ...
    <td width="288" height="50" align="left"> 
    <div align="left" style="padding-top:3px;">
    <form id="scaner" name="scaner" method="post" action="<?php echo get_option('siteurl'); ?>/wp-admin/admin.php?page=oQeySkins&amp;scaner=true">     
...
jQuery(".get_new_skins").click(function(){		
			...
			jQuery.post("<?php echo oQeyPluginUrl(); ?>/do.php", { get_new_skins: "yes" },
            function(r){
			jQuery("#new_skins").html(r);
			 
			jQuery(".install_skin").click(function(){
			var id = jQuery(this).attr("id");
			jQuery.post("<?php echo oQeyPluginUrl(); ?>/do.php", { install_new_skin: id, nonce: "<?php echo wp_create_nonce('oqey-install-skin'); ?>" },
            function(r){
              if(r=="ok"){ refreshPage(); }
