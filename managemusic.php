...
if(isset($_GET['scaner'])){
	$root = ABSPATH."wp-content/oqey_gallery/music";
...
<div class="wrap">
        <h2>Manage Music</h2>
<?php 
  $gal_dir_musica = ABSPATH."/wp-content/oqey_gallery/music";   
...
<div id="flashuploader" style="width:100px; height:30px;"></div>	   
    <script type="text/javascript">
	var flashvars = {BatchUploadPath:"<?php echo ABSPATH; ?>wp-content/oqey_gallery/music",
