...
jQuery.post(userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { songtotrash: id },
   function(id){
...
hoverSongs();
jQuery(".click").editable(userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { 
...
Notes: <br />
         ...
         * Your audio folder location:<b> <?php echo get_option('siteurl').'/wp-content/oqey_gallery/music/'; ?></b>       
    </div>
</div>
<script type="text/javascript">
