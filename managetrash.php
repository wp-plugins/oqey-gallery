...
if(id==2){
		...
		jQuery.post(userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { imgallfromtrash: encodeURIComponent(names), galid: galid },
        function(data){
		if(names.length>0){
...
if(id==3){
        ...
        jQuery.post(userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { imgalldelete: encodeURIComponent(names), galid: galid },
        function(data){
		if(names.length>0){			
...
jQuery.post(userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { deletesong: id, name: name },
   function(data){
...
jQuery.post(userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { restoresong: id },
   function(data){
            jQuery("#row_" + id).fadeOut('slow');
			if(data=="no"){ jQuery("#tabs-11").fadeOut(); }
...
jQuery.post(userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { deleteskinper: id, name: name },
   function(data){
            jQuery("#skin_tr_" + id).fadeOut('slow');
...
jQuery.post(userSettings['url'] + "wp-content/plugins/oqey-gallery/do.php", { deletegall: id, name: name },
   function(data){
	        jQuery("#row_" + id).fadeOut('slow');
